[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=24279438)
...
| Criteria                     | Excellent (5) | Needs Improvement (0) |
|------------------------------|----------------|-----------------------|
| **User Input**               | Correctly asks the user for a book and chapter found in the Book of Mormon. | Does not ask the user for a book and chapter. |
| **API Request**              | Correctly uses the open scripture API to retrieve the desired book and chapter. | Does not use the API correctly. |
| **Output**                   | Correctly prints out the summary for the specified chapter. | Does not print the summary correctly. |
| **Code Submitted to GitHub** | Code is well-organized, commented, and follows best practices. | Code is disorganized and does not follow best practices. |
